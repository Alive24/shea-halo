...
- Result: `{{result}}` {{pr_line}} {{artifact_line}} {{ledger_line}}
...
{{operator_action_section}} {{gemini_health_section}} {{usage_limit_section}} {{inconclusive_section}}
...
{{stdout_section}} {{stderr_section}} {{pass_evidence_section}}
